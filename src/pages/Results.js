    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      >
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="bg-yellow-50 border-l-4 border-yellow-500 p-4 mb-8 rounded-r-lg"
        >
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-sm text-yellow-700">
                This assessment is powered by artificial intelligence and is <strong>not a substitute for professional medical advice, diagnosis, or treatment</strong>. 
                The results provided are for informational purposes only and should not be used as a basis for medical decisions. 
                Always consult with a qualified healthcare provider for medical concerns and before making any health-related decisions.
              </p>
            </div>
          </div>
        </motion.div>
